...
listContainer.addEventListener("click", function(e){
    if(e.target.tagName === "LI"){
        e.target.classList.toggle("checked");//nese o e shtajpet vene at image me rethin e mbushet
    }
      else if(e.target.tagname === "SPAN"){
        e.target.parentElement.remove();//e heken vijen e paragrafit t deshiruar
        saveData();
      } 
